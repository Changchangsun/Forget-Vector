...
def parse_args():
    ...
    ##################################### Training setting #################################################
    parser.add_argument("--batch_size", type=int, default=256, help="batch size")#256,64,128,, before 256, now try 512
    ...
    parser.add_argument(
    "--multi_classes_to_replace", type=int, nargs='+', default = None, help="Specific class(es) to forget"
)
    parser.add_argument(
        "--class_to_replace_random_label", type=int, help="Specific class to forget of the random label unlearn method"
    )
    parser.add_argument(
        "--schedule", type=int, default = 1, help="Specific class to forget of the random label unlearn method"
    )
    parser.add_argument(
        "--indexes_to_replace",
        type=list,
    ...
    parser.add_argument(
        ...
        type=str, 
        default=None, 
        help="record the result in txt file.",
    )
    # --test_method
    parser.add_argument(
        "--test_method",
...
#
    parser.add_argument(
            ...
            type=str, 
            default=None, 
            help="record the result in wandb.",
        )
    ...
    parser.add_argument(
        "--case_w", type=int, default = 0, help="Specific class to forget of the random label unlearn method"
    )
    parser.add_argument("--module", default=None, type=str, help="unlearn noise")


    # test_epoch_s = args.test_epoch_s
    #         test_epoch_e = args.test_epoch_e
    parser.add_argument(
        "--test_epoch_s",
        type=int, 
        default=0, 
