...
def SVC_MIA(train_pos, train_neg, test_pos, test_neg, model):
    
    shadow_train_prob, shadow_train_labels = collect_prob(train_pos, model) 
    shadow_test_prob, shadow_test_labels = collect_prob(train_neg, model)  

    target_train_prob, target_train_labels = collect_prob(test_pos, model)
    target_test_prob, target_test_labels = collect_prob(test_neg, model)
