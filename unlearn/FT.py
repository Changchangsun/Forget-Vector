...
def FT_iter(data_loaders, model, criterion, optimizer, epoch, args, with_l1=False):
    ...
    print("1 train_accuracy {top1.avg:.3f}".format(top1=top1))
    print("1 train_loss {losses.avg:.3f}".format(losses=losses))
    
    # print("2 train_accuracy {top1.avg:.3f}".format(top1=top1.avg))
    # print("2 train_loss {losses.avg:.3f}".format(losses=losses.avg))
